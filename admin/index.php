...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">HealthPoint</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="index.php?halaman=customer">
      ...
      <li class="nav-item">
        <a class="nav-link " href="index.php?halaman=guest">
      ...
      <div class="row">
        ...
        if (isset($_GET['halaman'])) {
          ...
          elseif ($_GET['halaman'] == 'kategori') {
            ...
            include 'tambah_kat.php';
          } elseif ($_GET['halaman'] == 'edit_kat') {
            include 'edit_kat.php';
          } elseif ($_GET['halaman'] == 'hapus_kat') {
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>KharismaAgustya</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
